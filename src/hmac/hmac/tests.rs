...
fn hmac_sha1() {
    // (hash, text, key)
    let cases = [
        ("4f4ca3d5d68ba7cc0a1208c9c61e9c5da0403c0a", "Sample #1", vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
        ...
        ("0922d3405faa3d194f82a45830737d5cc6c75d24", "Sample #2", vec![0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37,
                                                                       0x38, 0x39, 0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x3f,
                                                                       0x40, 0x41, 0x42, 0x43,]),
        ("bcf41eab8bb2d802f3d05caf7cb092ecf8d1a3aa", "Sample #3", vec![0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57,
                                                                       ...
                                                                       0xb0, 0xb1, 0xb2, 0xb3,]),
        ("5fd596ee78d5553c8ff4e72d266dfd192366da29", "Sample message for keylen=blocklen", vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                                                                                0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
                                                                                                0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
                                                                                                0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,
                                                                                                0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27,
                                                                                                ...
                                                                                                0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37,
                                                                                                0x38, 0x39, 0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x3f,]),
        ("4c99ff0cb1b31bd33f8431dbaf4d17fcd356a807", "Sample message for keylen<blocklen", vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                                                                                0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
                                                                                                0x10, 0x11, 0x12, 0x13,]),
        ("2d51b2f7750e410584662e38f133435f4c4fd42a", "Sample message for keylen=blocklen", vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                                                                                0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
                                                                                                0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
                                                                                                0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,
                                                                                                0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27,
    ...
    let sha = SHA::sha1();
    let mut hmac = HMAC::new(Vec::new(), sha).unwrap();
    let mut mac = Vec::new();
    cases.iter().for_each(|e| {
        hmac.set_key(e.2.clone());
        hmac.write(e.1.as_bytes());
...
fn hmac_sha224() {
    let cases = [
        ("c7405e3ae058e8cd30b08b4140248581ed174cb34e1224bcc1efc81b", "Sample message for keylen=blocklen".as_bytes().to_vec(), vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                                                                                                0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
                                                                                                                0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
                                                                                                                0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,
                                                                                                                0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27,
                                                                                                                ...
                                                                                                                0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37,
                                                                                                                0x38, 0x39, 0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x3f,]),
        ("e3d249a8cfb67ef8b7a169e9a0a599714a2cecba65999a51beb8fbbe", "Sample message for keylen<blocklen".as_bytes().to_vec(), vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                                                                                                                    0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
                                                                                                                                    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
                                                                                                                                    0x18, 0x19, 0x1a, 0x1b,]),
        ("91c52509e5af8531601ae6230099d90bef88aaefb961f4080abc014d", "Sample message for keylen=blocklen".as_bytes().to_vec(), vec![0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                                                                                                                    0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
                                                                                                                                    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
                                                                                                                                    0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,
                                                                                                                                    0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27,
...
fn hmac_md5() {
    let cases = [
        ("750c783e6ab0b503eaa86e310a5db738", "what do ya want for nothing?".as_bytes().to_vec(), vec![74, 101, 102, 101]),
    ];
    
    let md5 = MD5::new();
    let mut hmac = HMAC::new(Vec::new(), md5).unwrap();
    let mut mac = Vec::new();
    cases.iter().for_each(|e| {
        hmac.set_key(e.2.clone());
        hmac.write(e.1.as_slice());
